...
- [x] 1.2 Provenance gains the pending-review state written by import (delivered by adopt-block-review)
- [x] 1.3 Adoption skill in the deck formalizing the process (adopt-artifact wraps rune import)
- [x] 1.4 `rune adopt` review state machine (delivered by adopt-block-review, supersedes the launch-dispatch shape)
